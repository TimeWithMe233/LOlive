...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable {
    ...
    public void processTryUseItem(CPacketPlayerTryUseItem p_processTryUseItem_1_) {
        PacketThreadUtil.checkThreadAndEnqueue(p_processTryUseItem_1_, this, this.playerEntity.getServerForPlayer());
        WorldServer worldserver = this.serverController.worldServerForDimension(this.playerEntity.dimension);
        ItemStack itemstack = this.playerEntity.getHeldItem();
        this.playerEntity.markPlayerActive();
        if (itemstack != null) {
            this.playerEntity.theItemInWorldManager.tryUseItem(this.playerEntity, worldserver, itemstack);
            //this.playerEntity.theItemInWorldManager.activateBlockOrUseItem(this.playerEntity, worldserver, itemstack, enumhand);
        }
    }
