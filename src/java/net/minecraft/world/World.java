                    ...
                    if ((!flag2 || !flag3) && this.isBlockLoaded(blockpos$pooledmutableblockpos.setPos(k1, 64, l1)))
                    {
                        for (int i2 = k; i2 < l; ++i2)
                        {
                            if (!flag2 && !flag3 || i2 != l - 1)
                            {
                                ...
                                if ( mc.thePlayer != null && mc.thePlayer.getDistanceSq(blockpos$pooledmutableblockpos) >= 100) continue;
            ...
            for (int k1 = i; k1 < j; ++k1) {
                for (int l1 = k; l1 < l; ++l1) {
                    for (int i2 = i1; i2 < j1; ++i2) {
                        ...
                        Block block = iblockstate.getBlock();
                        if(NoLiquid.shouldCancelWater && (block == Blocks.water || block == Blocks.flowing_water)){
                            continue;
                        }
                        if(NoLiquid.shouldCancelWater && (block == Blocks.lava || block == Blocks.flowing_lava)){
                            continue;
                        }
