...
import dev.olive.event.impl.events.EventBlockCollision;
...
public class Block {
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        ...
        if (isEnabled && XRay.blockIdList.contains(getIdFromBlock(this))) {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (collidingEntity instanceof EntityPlayerSP) {
            final EventBlockCollision event = new EventBlockCollision(this, pos, axisalignedbb);
    ...
    public EnumWorldBlockLayer getBlockLayer() {
        return isEnabled ? XRay.blockIdList.contains(getIdFromBlock(this)) ?
                EnumWorldBlockLayer.SOLID : EnumWorldBlockLayer.TRANSLUCENT : EnumWorldBlockLayer.SOLID;
    }
