...
import dev.olive.ui.gui.main.CustomMainMenu;
import dev.olive.utils.render.RenderUtil;
import dev.olive.utils.sound.WAVPlayer;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawImage(new ResourceLocation("olive/background.png"), -30, -30, this.res.getScaledWidth() + 60, this.res.getScaledHeight() + 60);
        GlStateManager.translate(-this.currentX / 30.0F, -this.currentY / 15.0F, 0.0F);
        ...
        FontManager.bold34.drawString('X' + "§f" + "Xy".substring(1), 45, 18, new Color(251, 193, 25).getRGB());

        FontManager.bold34.drawString("litol", 65, 18, -1);
