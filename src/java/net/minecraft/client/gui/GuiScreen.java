...
import dev.olive.event.impl.events.EventSendChatMessage;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawBackground(int tint)
    {
        ...
        Client.instance.wallpaperEngine.render(w, h);
    }
    ...
    public static boolean isKeyComboCtrlF(int keyID)
    {
        return keyID == 33 && isCtrlKeyDown() && !isShiftKeyDown() && !isAltKeyDown();
    }
