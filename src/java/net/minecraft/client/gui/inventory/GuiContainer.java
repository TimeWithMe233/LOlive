...
import dev.olive.module.impl.player.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        ChestStealer stealer = Client.instance.moduleManager.getModule(ChestStealer.class);
        Minecraft mc = Minecraft.getMinecraft();
        GuiScreen guiScreen = mc.currentScreen;
        if (stealer.getState() && stealer.silentValue.getValue()) {
            if (guiScreen instanceof GuiChest) {
                GuiChest chest = (GuiChest) guiScreen;
                if (!(stealer.silentValue.getValue() && (chest.lowerChestInventory == null))) {
                    // mouse focus
                    mc.setIngameFocus();
            ...
            if (guiScreen instanceof GuiFurnace) {
                ...
                mc.currentScreen = guiScreen;
                // hide GUI
                String tipString = "Stealing Furnace";
            ...
            if ( guiScreen instanceof GuiBrewingStand) {
                ...
                mc.currentScreen = guiScreen;
                // hide GUI
                String tipString = "Stealing BrewingStand";
