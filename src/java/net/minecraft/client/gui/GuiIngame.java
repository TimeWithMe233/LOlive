...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Client.instance.eventManager.call(new EventPreRender());
        ...
        if (this.mc.thePlayer.isRidingHorse()) {
            ...
            if (HUD.statsMode.is("Normal")) {
                this.renderExpBar(scaledresolution, k1);
            }
        }else if(HUD.statsMode.is("New")){
        ...
        if (this.titlesTimer > 0) {
            ...
            if (i2 > 8) {
                ...
                this.displayedTitle = org.apache.commons.lang3.StringUtils.replace(this.displayedTitle, "花雨庭", "花雨庭");
        ...
        // Checking shits
        if (scoreobjective1 != null && Client.instance.getHudManager().hudObjects.get("Scoreboard") != null && !Client.instance.getHudManager().hudObjects.get("Scoreboard").m.state) {
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(2.0F, (float) (j - 28), 0.0F);
        persistantChatGUI.texts.forEach(Runnable::run);
        GlStateManager.popMatrix();

//        KawaseBloom.shadow(() -> , 3, 1);
        ...
        Client.instance.eventManager.call(new EventRender2D(partialTicks, scaledresolution));
        ...
        try {
            if (HUD.hotbarMode.is("Normal")) {
                if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
                    ...
                    this.drawTexturedModalRect(i - 91 - 1 + Client.instance.getSlotSpoofManager().getSpoofedSlot() * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
                    this.zLevel = f;
                ...
                if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
                    ...
                    RenderUtil.drawFastRoundedRect(i - 91,
                       sr.getScaledHeight() - 22,
                            ...
                            0, new Color(28, 28, 28, 183).getRGB());
                    RenderUtil.drawFastRoundedRect(i - 91 + (int)anim,
                            sr.getScaledHeight() - 22,
                            i - 69 + (int)anim,
                            this.mc.ingameGUI.getChatGUI().getChatOpen() ? sr.getScaledHeight() - 15 : sr.getScaledHeight() - 1,
                            0, new Color(233, 233, 233, 100).getRGB());
                    this.zLevel = f;
                    GlStateManager.enableRescaleNormal();
                    GlStateManager.enableBlend();
                    GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
            ...
            if (k > 0) {
                ...
                if (HUD.statsMode.is("Normal")){
                    ...
                    this.getFontRenderer().drawStringWithShadow(s, (float) i, (float) j-7, 16777215 + (k << 24));
                }
        ...
        for (Score score1 : collection) {
            ...
            drawRect(l1 - 2, k, l, k + this.getFontRenderer().FONT_HEIGHT, 1342177280);
         {
            ...
            if (j == collection.size()) {
                String s3 = org.apache.commons.lang3.StringUtils.replace(org.apache.commons.lang3.StringUtils.replace(objective.getDisplayName(), "花雨庭", "花雨庭"), "§c✿", "§c✿");
    ...
    private final ContinualAnimation healthAnim2 = new ContinualAnimation();
    ...
    private void renderPlayerStats(ScaledResolution scaledRes) {
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            int L1 = scaledRes.getScaledWidth() / 2;
            ...
            if (entityplayer.isPotionActive(Potion.regeneration)) {
              ...
              if (HUD.statsMode.is("Noraml")) {
                  ...
                  if (entityplayer.getTotalArmorValue() > 0) {
                      ...
                      RenderUtil.drawRectWH(halfWidth - 91, k1-16, 182f, 13.5f, new Color(43, 42, 43).getRGB());
                      RenderUtil.drawRectWH(halfWidth - 91, k1-16, 182f * armorAnim.getOutput(), 13.5f,  new Color(0, 137, 168).getRGB());
                      bold18.drawString("ABSORPTION: " + entityplayer.getTotalArmorValue(), halfWidth - 91 + 2, k1 + 5.5f - bold18.getHeight() / 2f-3-9, -1);
                  }
              }
              ...
              if(HUD.statsMode.is("Normal")) {
                  ...
                  healthAnim2.animate(Math.min(( entityplayer.getAbsorptionAmount()) / entityplayer.getMaxHealth(), 1), 18);
                  RenderUtil.drawRectWH(halfWidth - 91, k1+1, 182, 13.5f,  new Color(43, 42, 43,194).getRGB());
                  RenderUtil.drawRectWH(halfWidth - 91, k1+1, 182 * healthAnim.getOutput(), 13.5f,  new Color(0, 168, 107).getRGB());
                  if (Math.ceil(entityplayer.getHealth() + entityplayer.getAbsorptionAmount())>20){
                      RenderUtil.drawRectWH(halfWidth+94,k1+1,80*healthAnim2.getOutput(),13.5f,new Color(237, 235, 19, 190).getRGB());
                  }
                  bold18.drawString( Math.ceil(entityplayer.getHealth() + entityplayer.getAbsorptionAmount()) + " | " + entityplayer.getMaxHealth(), halfWidth - 91 + 2, k1 + 10.5f - bold18.getHeight() / 2f, -1);
