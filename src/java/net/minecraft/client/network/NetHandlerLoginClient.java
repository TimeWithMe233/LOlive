...
//        mc.getNetHandler().getNetworkManager().sendPacketWithoutHigherPacket(new C17PacketCustomPayload("FML|HS", new PacketBuffer(Unpooled.wrappedBuffer(new byte[]{0x01, 0x02}))));

//        PacketProcessor.INSTANCE.setCurrentState(FMLHandshakeClientState.START);
