...
import dev.olive.utils.render.animation.impl.LayeringAnimation;
...
import static dev.olive.module.impl.player.XRay.isEnabled;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private void hurtCameraEffect(float partialTicks) {
        ...
        if (camera.getState() && camera.noHurtCameraValue.getValue()) return;
    ...
    private void setupViewBobbing(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            if (camera.getState()) {
                if (!camera.betterBobbingValue.getValue()) {
    ...
    public void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                if (camera.getState()) {
                    if (!camera.cameraClipValue.getValue()) {
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (world != null) {
                ...
                for (int i = 0; i < 256; ++i) {
                    ...
                    float f16 = isEnabled ? 10000.0F : this.mc.gameSettings.gammaSetting;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        GL11.glPushMatrix();
        Client.instance.eventManager.call(new EventRender3D(partialTicks));
