...
import dev.olive.event.impl.events.EventRenderPlayer;
import dev.olive.utils.render.waveycapes.renderlayers.CustomCapeRenderLayer;
...
//        this.addLayer(new LayerCape(this));
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks) {
        EventRenderPlayer e = new EventRenderPlayer(EventRenderPlayer.REventState.PRE);
        ...
        e.eventState = EventRenderPlayer.REventState.POST;
        Client.instance.eventManager.call(e);
