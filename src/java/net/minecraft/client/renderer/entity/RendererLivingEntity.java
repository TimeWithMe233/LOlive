...
import dev.olive.event.impl.events.EventRLE;
import dev.olive.event.impl.events.RenderNameTagEvent;
import dev.olive.module.impl.render.ESP;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public static boolean setShaderBrightness(Color color) {
        ...
        GL11.glTexEnvfv(GL11.GL_TEXTURE_ENV, GL11.GL_TEXTURE_ENV_COLOR, shaderBrightnessBuffer);
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            ...
            try {
                ...
                if (entity instanceof EntityPlayer) {
                    ...
                    Client.instance.eventManager.call(Eventrle);
            ...
            if (entity instanceof EntityPlayer) {
                ...
                Client.instance.eventManager.call(rleEvent);
            }
        }
    }
    ...
    protected boolean canRenderName(T entity) {
        ...
        if (Client.instance.moduleManager.getModule(ESP.class).state) {
            return false;
        }
