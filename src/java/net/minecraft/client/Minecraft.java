...
import dev.olive.module.impl.render.MotionBlur;
...
import static dev.olive.utils.render.RenderUtil.drawRect;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("You are joining zhe Olive...");
    }
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air && this.playerController.onPlayerDamageBlock(blockpos, this.objectMouseOver.sideHit)) {
                    ...
                    Client.instance.eventManager.call(new EventClickBlock(this.objectMouseOver.getBlockPos(), this.objectMouseOver.sideHit));
    ...
    public void runTick() throws IOException {
        ...
        if (this.thePlayer != null) {
            Client.instance.eventManager.call(new EventTick());
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    ...
                    if (!(this.gameSettings.touchscreen && this.touchValue++ > 0)) {
                        EventClick eventClick = new EventClick(Mouse.getEventButton());
                        if (Client.instance != null && Client.instance.eventManager != null)
                            Client.instance.eventManager.call(eventClick);
                    }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        Client.instance.eventManager.call(reloadEvent);
        ...
        if (worldClientIn != null) {
            ...
            Client.instance.eventManager.call(new WorldEvent());
        } else {
