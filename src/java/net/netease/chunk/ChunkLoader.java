...
public class ChunkLoader implements IChunkLoader, IThreadedFileIO {
    ...
    public ChunkLoader(File chunkSaveLocationIn) {
    ...
    public Chunk loadChunk(World worldIn, int x, int z) throws IOException {
        ...
        if (nbttagcompound == null) {
            DataInputStream datainputstream = RegionFileManager.getChunkInputStream(this.chunkSaveLocation, x, z);
    ...
    private void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound p_75820_3_) {
        ...
        for (i1 = 0; i1 < chunkIn.getEntityLists().length; ++i1) {
            var22 = chunkIn.getEntityLists()[i1].iterator();
        ...
        while (var22.hasNext()) {
            TileEntity tileentity = (TileEntity) var22.next();
            nbttagcompound = new NBTTagCompound();
