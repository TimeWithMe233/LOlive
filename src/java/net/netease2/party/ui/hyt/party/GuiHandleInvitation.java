 ...
 */
package net.netease2.party.ui.hyt.party;

import dev.olive.utils.render.RenderUtil;
import net.netease2.party.Sender;
import net.netease2.party.ui.hyt.germ.component.impl.ClickableButton;
...
public class GuiHandleInvitation
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawImage(new ResourceLocation("olive/hyt/page/background.png"), (float) this.width / 2.0f - 100.0f, (float) this.height / 2.0f - 81.0f, 200.0f, 162.0f, -1);
