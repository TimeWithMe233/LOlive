...
import dev.olive.utils.player.TimeHelper;
import dev.olive.utils.render.animation.AnimationUtil;
...
public class UIFlatButton extends GuiButton {
    ...
    private final RapeMasterFontManager font;
    ...
    public UIFlatButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, int color) {
        ...
        this.color = color;
        this.font = FontManager.font15;
    }

    public UIFlatButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, int color, RapeMasterFontManager font) {
        super(buttonId, x, y, 10, 12, buttonText);
        this.width = widthIn;
        this.height = heightIn;
        this.enabled = true;
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        RenderUtil.drawRoundedRect2(this.xPosition, (float) this.yPosition, (int) ((this.xPosition + this.width)), (float) this.yPosition + radius * 2.0F, 3f,this.color);
        ...
        FontManager.font15.drawCenteredString(this.displayString, (float) (this.xPosition + this.width / 2), (float) this.yPosition + (float) (this.height - this.font.FONT_HEIGHT) / 2.0F + 2, new Color(255, 255, 255).getRGB());
