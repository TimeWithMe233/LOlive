...
import dev.olive.module.impl.combat.CombatStrafe;
...
public class MovementUtil
    ...
    public static void strafe(float speed, float yaw) {
        onStrafe = true;
        if (Client.instance.getModuleManager().getModule(CombatStrafe.class).getState() && AttackUtil.inCombat) {
            yaw = RotationUtil.clientRotation[0] + Client.instance.getModuleManager().getModule(CombatStrafe.class).getOffset();
        }
