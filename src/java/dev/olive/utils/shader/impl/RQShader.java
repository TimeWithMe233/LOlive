package dev.olive.utils.shader.impl;

import dev.olive.utils.shader.base.RiseShaderProgram;
import dev.olive.utils.shader.base.ShaderUniforms;
...
public class RQShader {
    ...
    private final RiseShaderProgram program = new RiseShaderProgram("rq.frag", "vertex2.vsh");
