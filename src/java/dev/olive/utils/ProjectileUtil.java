...
public class ProjectileUtil {
    public static ProjectileHit predict(double posX, double posY, double posZ, double motionX, double motionY, double motionZ, double motionSlowdown, double size, double gravity, boolean draw) {
        ...
        while (!hasLanded && posY > -60.0D) {
            ...
            List<Entity> entityList = Client.mc.theWorld.getEntitiesWithinAABB(Entity.class, arrowBox.addCoord(motionX, motionY, motionZ).expand(1.0D, 1.0D, 1.0D));
            ...
            motionY -= gravity;
            if (draw) {
                GL11.glVertex3d(posX - Client.mc.getRenderManager().getRenderPosX(), posY - Client.mc
                        .getRenderManager().getRenderPosY(), posZ - Client.mc
    ...
    public static class EnderPearlPredictor {
        ...
        private double assessSingleRotation(Vector2f rotation, double motionYOffset) {
            ...
            double posY = predictY + Client.mc.thePlayer.getEyeHeight() - 0.10000000149011612D;
        ...
        private double assessSingleBlockPos(BlockPos pos) {
            for (int y = 0; y >= -5; y--) {
                IBlockState blockState = Client.mc.theWorld.getBlockState(pos.add(0, y, 0));
    ...
    public static class ProjectileHit {
        ...
        public final MovingObjectPosition landingPosition;
