...
import dev.olive.utils.tuples.mutable.MutablePair;
import lombok.Getter;
import lombok.Setter;

import static dev.olive.ui.font.FontManager.font14;
...
public class TooltipObject implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        float fadeAnim = (float) fadeInAnimation.getOutput();
        ...
        if (tooltip.contains("\n")) {
            ...
            MutablePair<Float, Float> whPair = font14.drawNewLineText(tooltip, x + 2, y + 2, ColorUtil.applyOpacity(-1, fadeAnim), 3);

            float additionalHeight = 0;
            if (additionalInformation != null) {
                additionalHeight = font14.drawWrappedText(additionalInformation, x + 2,
            ...
            width = font14.getStringWidth(tooltip) + 4;
            height = font14.getHeight() + 2;
            ...
            font14.drawCenteredString(tooltip, x + width / 2f, y + font14.getMiddleOfBox(height), ColorUtil.applyOpacity(-1, fadeAnim));
