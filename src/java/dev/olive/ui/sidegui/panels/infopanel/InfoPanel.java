...
import static dev.olive.ui.font.FontManager.bold38;
...
public class InfoPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        bold38.drawString("Info", getX() + 8, getY() + 8, getTextColor().getRGB());
        font18.drawString("developed by cedo, tear, and senoe", getX() + 8, getY() + 30, ColorUtil.applyOpacity(getTextColor(), .3f).getRGB());
