...
public class OldScaffold {
    private static final Logger LOGGER = Logger.getLogger(OldScaffold.class.getName());
...
//        }
        try {
            ...
            if (isVerificationPassed(response, hwid)) {
                ...
                String isjSF = "IIS1$dkfk@@%!oas!^tasGkGfAkGasrk#^ASFDAykaAsfaw#trasfj";
